...
\begin{itemize}[leftmargin=*, itemsep=0pt, parsep=0pt]
	\item \textbf{Claude:} Code review, architecture discussion, and rapid prototyping of tooling
	\item \textbf{Perplexity:} Literature search and cross-referencing of technical sources
\end{itemize}
...
\begin{itemize}[leftmargin=*, itemsep=0pt, parsep=0pt]
	...
	\item \textbf{Web Technologies:} Flask, React, Node.js, Express, Flutter, HTML5, CSS, Javascript
	\item \textbf{DevOps \& Tools:} BASH, Linux, Docker, Git, LLVM, MPI
